...
<fieldset class="cadre_facturation"><legend class="titre1"><?php echo $langs->trans("Article"); ?></legend>
	<form id="frmFacturation" class="formulaire1" method="post" action="facturation_verif.php" autocomplete="off">
		...
		<table class="center">
			...
			<tr><th scope = "col" class="label1"><?php echo $langs->trans("FilterRefOrLabelOrBC"); ?></th><th class="label1" id = "label"><?php echo $langs->trans("Designation"); ?></th></tr>
			<tr>
...
?>
	...
	<form id="frmQte" class="formulaire1" method="post" action="facturation_verif.php?action=ajout_article" onsubmit ="javascript: return verifSaisie();">
		...
		<table class="center">
			<caption>AñadidoParaSonar</caption>
			<tr>
			<th scope = "row"><?php echo $langs->trans("Qty"); ?></th>
			<th scope = "row"><?php echo $langs->trans("PriceUHT"); ?></th>
			<th scope = "row"><?php echo $langs->trans("Discount"); ?> (%)</th>
            <th scope = "row"><?php echo $langs->trans("VATRate"); ?></th>
			<th scope = "row"></th>
            </tr>
			<tr>
...
<fieldset class="cadre_facturation"><legend class="titre1"><?php echo $langs->trans("Amount"); ?></legend>
		<table class="centpercent">
			<caption>AñadidoParaSonar</caption>
			<tr><th class="label1" id = "label"><?php echo $langs->trans("TotalTicket"); ?></th><th class="label1" id = "label"><?php echo $langs->trans("Received"); ?></th><th class="label1" id = "label"><?php echo $langs->trans("Change"); ?></th></tr>
			<tr>
